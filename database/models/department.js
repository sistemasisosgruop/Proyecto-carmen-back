...
module.exports = (sequelize, DataTypes) => {
  class Departments extends Model {
    static associate(models) {
      ...
      Departments.hasMany(models.Department_Images, { as: 'departmentImages', foreignKey: 'departmentId' })
    }
  }
  Departments.init({
    id: {
    ...
    scopes: {
      public_view: {
        attributes: ['departmentType', 'description', 'address', 'price', 'checkId', 'checkOut', 'numBathrooms', 'numBeds', 'extras']
      }
    },
  });
  return Departments;
